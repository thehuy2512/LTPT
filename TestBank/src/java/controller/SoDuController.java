 ...
 * @author Dell
 */
@WebServlet(name = "SoDuController", urlPatterns = {"/SoDu"})
public class SoDuController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        TaiKhoanbean tk= getTaiKhoan(tamtk);
        session.setAttribute("tk", tk);
        RequestDispatcher rd = request.getRequestDispatcher("SoDu.jsp");
